          ...
          <el-table-column prop="status" :label="$t('home.new_case.api_status')" width="170">
            <template v-slot:default="scope">
              <span class="el-dropdown-link">
                <basic-status-lable :value="scope.row.status"/>
              </span>
            </template>
          </el-table-column>
          <!--更新时间-->
...
import BasicStatusLable from "@/business/home/components/BasicStatusLabel";
...
export default {
  ...
  components: {
    BasicStatus,
    BasicStatusLable, ApiStatus, MsTablePagination
  },
  data() {
    return {
      result: false,
